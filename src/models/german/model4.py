...
dataset_orig = GermanDataset(protected_attribute_names=['sex'],
                            ...
                            features_to_keep=['age', 'sex', 'employment', 'housing', 'credit_amount', 'month', 'purpose'],
...
gs = SVC(C=0.85, break_ties=False, cache_size=200, class_weight=None, coef0=0.0,
    decision_function_shape='ovr', degree=3, gamma='scale', kernel='linear',
    max_iter=-1, random_state=42, shrinking=True, tol=0.001, probability=True,
    verbose=False)
model = make_pipeline(StandardScaler(), gs)
