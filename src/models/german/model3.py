...
dataset_orig = GermanDataset(protected_attribute_names=['sex'],
                            ...
                            features_to_keep=['age', 'status', 'credit_history', 'purpose', 'savings', 'employment', 'sex', 'property', 'installment_plans', 'housing', 'foreign_worker'],
...
model = XGBClassifier()
mdl = model.fit(data_orig_train.features, data_orig_train.labels.ravel())
