...
model = XGBClassifier(n_estimators=1600,learning_rate=0.05)
mdl = model.fit(X_train, y_train, early_stopping_rounds=400, eval_set=eval_set, verbose=False)
